from smarthouse.domain import Device, SmartHouse
...
motion_sensor = Device("9e5b8274-4e77-4e8e-80d2-b40d648ea04b", "NebulaGuard Innovations", "MoveZ Detect 69", "sensor", "Motion sensor")
...
c02_sensor = Device("8a43b2d7-e8d3-4f3d-b832-7dbf37bf629e", "ElysianTech", "Smoke Warden 1000","sensor","CO2 sensor")
DEMO_HOUSE.register_device(LivingRoomKitchen, c02_sensor)

electricity_meter= Device("a2f8690f-2b3a-43cd-90b8-9deea98b42a7", "MysticEnergy Innovations", "Volt Watch Elite","sensor","Electricity Meter")
DEMO_HOUSE.register_device(entrance, electricity_meter)


heat_pump= Device("5e13cabc-5c58-4bb3-82a2-3039e4480a6d", "ElysianTech", "Thermo Smart 6000","actuator","Heat Pump")
DEMO_HOUSE.register_device(LivingRoomKitchen, heat_pump)

humidity_sensor = Device("3d87e5c0-8716-4b0b-9c67-087eaaed7b45", "AetherCorp", "Aqua Alert 800","sensor","Humidity Sensor")
DEMO_HOUSE.register_device(Bathroom1, humidity_sensor)

smart_oven1 = Device("8d4e4c98-21a9-4d1e-bf18-523285ad90f6", "AetherCorp", "Pheonix HEAT 333","actuator","Smart oven")
DEMO_HOUSE.register_device(guestRoom1, smart_oven1)

Automatic_garage_door = Device("9a54c1ec-0cb5-45a7-b20d-2a7349f1b132", "MythicalTech", "Guardian Lock 9000","actuator","Automatic Garage Door")
DEMO_HOUSE.register_device(garage, Automatic_garage_door)


smart_oven2 = Device("c1e8fa9c-4b8d-487a-a1a5-2b148ee9d2d1", "IgnisTech Solutions", "Ember Heat 3000","actuator","Smart oven")
DEMO_HOUSE.register_device(Masterbedroom, smart_oven2)

Temperature_sensor = Device("4d8b1d62-7921-4917-9b70-bbd31f6e2e8e", "AetherCorp", "SmartTemp 42","sensor","Temperature sensor")
DEMO_HOUSE.register_device(Masterbedroom, Temperature_sensor)

Air_Quality_Sensor = Device("7c6e35e1-2d8b-4d81-a586-5d01a03bb02c", "CelestialSense Technologies", "AeroGuard Pro","sensor","Air Quality Sensor")
DEMO_HOUSE.register_device(guestRoom3, Air_Quality_Sensor)

Smart_plug = Device("1a66c3d6-22b2-446e-bf5c-eb5b9d1a8c79", "MysticEnergy Innovations", "FlowState X","actuator","Smart Plug")
DEMO_HOUSE.register_device(Office, Smart_plug)

Dehumidifier = Device("9e5b8274-4e77-4e4e-80d2-b40d648ea02a", "ArcaneTech Solutions", "Hydra Dry 8000","actuator","Dehumidifier")
DEMO_HOUSE.register_device(Bathroom2, Dehumidifier)

Light_bulp = Device("6b1c5f6b-37f6-4e3d-9145-1cfbe2f1fc28", "Elysian Tech", "Lumina Glow 4000","actuator","Light bulp")
